...
public:
	...
	static const uint32_t SEND_COMPLETION_QUEUE_LENGTH = 2; 		// Must be less than MAX_CQE

	static const uint32_t RECV_COMPLETION_QUEUE_LENGTH = 2; 		// Must be less than MAX_CQE
